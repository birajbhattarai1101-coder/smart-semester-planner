...
export default function LoginPage({ initialMode = "login" }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F5F2EE", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Plus Jakarta Sans', sans-serif", padding: "20px" }}>
      <style>{`input::-ms-reveal, input::-ms-clear { display: none; } input[type="password"]::-webkit-credentials-auto-fill-button { display: none; } html, body, #root { margin: 0; padding: 0; width: 100%; height: 100%; }`}</style>
