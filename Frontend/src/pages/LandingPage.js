...
export default function LandingPage() {
  ...
  return (
    <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", background: "#FAF8F4", minHeight: "100vh", display: "flex", flexDirection: "column", margin: 0, padding: 0, width: "100%" }}>
      <style>{`* { margin: 0; padding: 0; box-sizing: border-box; } body { margin: 0; padding: 0; overflow-x: hidden; }`}</style>
      ...
      {/* HERO */}
      <section style={{ minHeight: "calc(100vh - 61px)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "60px 48px", textAlign: "center", background: "linear-gradient(180deg, #FFFFFF 0%, #EDE0CC 100%)" }}>
      ...
      {/* FOOTER */}
      <footer style={{ background: "#2C1810", padding: "44px 48px", textAlign: "center", width: "100%", boxSizing: "border-box" }}>
